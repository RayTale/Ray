...
namespace Ray.Storage.PostgreSQL
{
    ...
    {
        public StringStorageOptions(IServiceProvider serviceProvider, string connectionKey, string uniqueName, long subTableMinutesInterval = 30, int stateIdLength = 200) : base(serviceProvider)
        {
